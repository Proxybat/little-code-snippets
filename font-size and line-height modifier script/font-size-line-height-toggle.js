...
function resizeText(multiplier) {
  ...
  document.body.style.fontSize =
    parseFloat(document.body.style.fontSize) + multiplier * 0.2 + "rem";
}
...
function resizeLine(multiplier) {
  if (document.body.style.lineHeight == "") {
    document.body.style.lineHeight = "1.2rem";
  }
  // adds or subtracts by 0.2rem
  document.body.style.lineHeight =
    parseFloat(document.body.style.lineHeight) + multiplier * 0.2 + "rem";
}
